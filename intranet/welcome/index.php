...
<html class="no-js css-menubar" lang="en">
    ...
    <body class="dashboard">
                                ...
                                <li role="presentation">
                                    <div class="mega-content">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <h5>Media <span class="badge badge-success">4</span> </h5>
                                                <ul class="blocks-3">
                                                    <li>
        ...
        <!--Plugins For This Page Intranet Welcome -->
        <script src="../../resources/public/lib/plugins/skycons/skycons.js"></script>
        ...
        <!--Scripts For This Page Intranet Welcome -->
        <script src="../../resources/public/lib/run/components/matchheight.js"></script>
        <!--<script src="../../resources/public/lib/run/components/jvectormap.js"></script>-->

        <script src="../../resources/public/lib/dashboard/v2.js"></script>
